                    ...
                    <div class="row @if (!$loop->last){{ 'mb-3' }}@endif">
                        ...
                        <div class="col-2 pt-1">
                            <div class="dropdown float-right">
                                <button class="btn btn-secondary btn-sm dropdown-toggle" type="button" id="pageManageButton-{{ $page->id }}" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Manage</button>
                                <div class="dropdown-menu" aria-labelledby="pageManageButton-{{ $page->id }}">
                                    @can('update', $page)
                                    <a href="{{ route('page.update', ['page' => $page->id, 'redirect=page.index']) }}" class="dropdown-item">Edit</a>
                                    @endcan
                                    @can('delete', $page)
